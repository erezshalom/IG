...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.il/StructureDefinition/ext-il-hmo']) &lt;= 1">extension with URL = 'http://fhir.health.gov.il/StructureDefinition/ext-il-hmo': maximum cardinality of 'extension' is 1</sch:assert>
