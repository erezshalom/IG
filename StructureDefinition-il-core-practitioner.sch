...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.il/StructureDefinition/ext-qualification-practice']) &lt;= 1">extension with URL = 'http://fhir.health.gov.il/StructureDefinition/ext-qualification-practice': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Practitioner.qualification.extension.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>Practitioner.qualification.extension.value[x] 1</sch:title>
    <sch:rule context="f:Practitioner/f:qualification/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
